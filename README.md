...
export DASHSCOPE_API_KEY=...       # Qwen â€” International (dashscope-intl.aliyuncs.com)
export DASHSCOPE_CN_API_KEY=...    # Qwen â€” China (dashscope.aliyuncs.com)
export ZHIPU_API_KEY=...           # GLM via Z.AI (international)
export ZHIPU_CN_API_KEY=...        # GLM via BigModel (China, open.bigmodel.cn)
export MINIMAX_API_KEY=...         # MiniMax â€” Global (api.minimax.io)
export MINIMAX_CN_API_KEY=...      # MiniMax â€” China (api.minimaxi.com)
...
- US: `AAPL`, `SPY`
- Hong Kong: `0700.HK` Â· Tokyo: `7203.T` Â· London: `AZN.L`
- India: `RELIANCE.NS`, `.BO` Â· Canada: `.TO` Â· Australia: `.AX`
